...
用 Linux 或者 OpenBSD 的人都是爲了炫耀？那可不一定。因爲「炫耀」的前提是自己的知識儲備必須足夠甚至超越對面的儲備，爲了展示自己的能力，往往就要再學習更多的知識...時間一長反可能成爲這一領域的專家。</br>
</br>

## 8月12日

花了不少時間給我的 x86 桌機安裝了 FreeBSD 15，不得不說 UFS 檔案系統在如今的 SSD 上也可以啓用 Trim 支援，但是硬體驅動仍然是個大問題。</br>
</br>

## 8月11日

Samsung 在中國的銷量非常慘淡，但依舊是 Android 旗艦的王。說明了什麼？即使沒有中國這個市場，照樣不會影響公司的經濟！看看 PINE 64 的例子就知道了。</br>
</br>

## 8月10日

回想了自己從接觸網路開始，使用過的所有搜尋引擎，並把牠們編成了一首歌，來紀念我的搜尋引擎變化歷史。</br>
</br>

## 8月9日

開源自架(軟體)出發，SearXNG (元)搜尋 </br>
集合搜尋，統一檢索，高度客製化 </br>
只需支援 Docker 容器就可以實作 </br>
**隱私牢牢掌控，做自己的大統領** </br>
</br>
...
「플래싱(Flashing) 少年」 應該是我覺得最好的別稱。雖然會和在 Minecraft 中建造鐵路的「FlashTeens」重名，但是「Flash」只有「刷機；刷寫」的意思。不像後者，因爲曾用 Flash 軟體做過動畫而把「FlashTeens」作爲自己的暱稱使用至今。</br>
</br>
...
## 8月2日
 ...
 - 似乎獨裁專制勝過自由民主，放在國家角度看是如此，放在自由軟體角度看依舊如此。看看全球哪家智慧型手機賣的最好，最有人氣？應該是 iPhone 吧！iOS 這種監獄生態包辦了妳的衣食住行，把使用者慢慢培養成爲什麼都無法做的「功能性文盲」。一旦脫離某公司的生態就無法使用手機，不知如何是好。突然遞給別人一個安裝了 AOSP-like Android 系統的裝置，看看會使用的人還剩下多少？如今 `systemd` 似乎要引入「遠端驗証」的猜想，之後使用者想要使用的軟體都必須要經過數位簽章，雲端驗証才可以繼續使用？越想就越覺得不對勁，好比自己家的鑰匙卻不在自己手上，每次開門都必須從第三者取得鑰匙一樣荒謬。雖然 Linux 套件管理員同樣有數位簽章，但僅用於驗証套件完整性，不會影響軟體安裝自由。想想過去，韌體引入的「安全性」變更，總會讓自由軟體使用者苦不堪言：UEFI 有安全啓動，Arm 平臺有基於硬體的安全啓動，還有 Bootloader 鎖和 Verfied boot...就算 Linux 要引入相關的安全性變更來保障使用者安全，拒絕被淪爲病毒和間諜軟體利用的「培養基」，也應該是 Optical，而不是 Force required 。如果 Linux ，或者講是 `systemd` 走上了 Android，iOS 和 Windows 一樣的道路，使用者不能自主決定安裝哪些應用程式；修改系統檔案必須通過雲端驗証，成爲新的「圍牆花園」...那麼 Linux 也就不再自由。自由軟體使用者將不再有安居之處，這篇部落格也就可以終止更新了。</br>
</br>

 - 如今的 Android，正在走上 iOS 那樣成爲「監獄生態」的道路。iOS 即使有 AltStore 這種側載管道，牠也是要向 Apple 註冊帳號，取得開發者憑證給 APP 簽名才能安裝。換言之，整個安裝流程依然只能在 Apple 指定的機制下才可以正常運作。在 iOS 上安裝任何 App ——包括透過側載安裝的 App ——都必須經過蘋果的程式碼簽章與授權系統核准。`installd` 系統程序會驗證 App 的簽章與佈建描述檔是否有效，否則 App 就無法安裝。此外，iOS 還有App Attest 服務能夠透過計算加密金鑰的方式，驗證 APP 是否遭篡改，杜絕 APP 被人扒出 IPA 側載的可能性，就是讓你只能從 App Stote 下載。雖說這能保護專有軟體開發者的利益不被侵犯，但又進一步加強了 iOS 的封閉性。因此，除非是原型機或者越獄的 iOS 裝置，iOS 基本沒有軟體安裝自由。原來 Play Integrity 就是抄這個機制的「複製品」啊... Google 或許會保留供進階使用者的「進階選項」，或許某一天，這所謂的「進階選項」也會被隱藏。大型科技公司仍然可以在未來的某個時刻奪走我們自由安裝軟體甚至是使用裝置的能力，因此不能專注於某幾家公司提供的服務和生態，必須「去中心化」，必要的服務可以考慮自建。</br>
 </br>


## 8月1日

剛好看到 PostmarketOS 有 Q6A 的 port，通過 `pmbootstrap` 安裝到 eMMC 上，開機只用了10秒(我使用 GNOME 桌面)！對於 eMMC 這種低速快閃記憶體來說，很贊。至於內建的 FCU760K Wi-Fi 網路卡也可以通過編譯安裝 `aic8800` out-of-tree 核心模組來解決。</br>
</br>

## 7月31日

從角落翻出很久以前給 Rock 5B 買的 eMMC 模組，放在 Q6A 單板機上，竟然可以工作！只是還沒有想好具體用途...</br>
</br>
...
[Using CAPTCHA for Compromise: Hackers Flip the Script](https://reliaquest.com/blog/using-captcha-for-compromise/)爲了蒐集妳的個資，如今連 Google/ Cloudflare Captcha 都可以被仿造，從外觀來看，和正版的 Captcha 程式根本沒有什麼區別。唯一的區別在於按下「請驗証您是真人」後，會提示需要執行指令搞才可以完成驗証。當然驗証是肯定做不了的，只會下載大量的危險「間諜軟體」隨系統開機執行而啓動，在背景偷偷蒐集使用者的資料。這樣看來，瀏覽器的權限不能開放得太大，很容易會造成安全問題。</br>
</br>
...
[我的七劃管熒幕小程式](https://github.com/Android-Piepaint/Dumb-POS-display-clock-monitor) 既然熒幕是通過 UART 與主機通訊的，那把熒幕改造爲單板電腦適用的 CPU/記憶體/時間 展示臺應該也可以？興奮地拿下熒幕，用杜邦線接到單板機上測試，發現在電腦上正常執行的程式移植到單板機上出現了位元錯亂問題，經過後期檢索得知這臺熒幕僅相容 X86 平臺常見的 RS-232 序列介面協定，而不是更爲在 Arm 單板機廣泛採用的 UART 通訊協定，需要安裝轉換晶片才可以使用。</br>
</br>

## 7月20日

原來 X86 晶片的內建顯示卡不一定要是 Intel 或者 AMD，也可以是 ARM 晶片上常見的 Mali 繪圖卡。後者被叫做「Intel MID」平臺，這些平臺採用 SFI 作爲開機韌體，使用 Device tree 而不是 ACPI 描述自身的硬體。</br>
</br>

## 7月19日

[Linux/4004](https://dmitry.gr/?r=05.Projects&proj=35.%20Linux4004)，只要有足夠的能力，即使在54年前的 Intel 4004 晶片上也可以跑 Linux！只是在這樣一個基頻時脈僅有750KHz 的4位元晶片跑 Linux，需要4.75天才可以開機...還不如我的486桌機呢，跑6.14核心只需要11小時就可以開機了www</br>
</br>
...
6F 6E 20 68 65 72 2E 20 54 68 65 20 72 65 73 75 6C 74 20 69 73 20 70 72 65 74 74 79 20 67 6F 6F 64 2C 20 61 6C 74 68 6F 75 67 68 20 74 68 65 20 6F 70 65 6E 65 64 20 66 6F 75 72 </br>
74 68 20 65 79 65 20 73 68 6F 77 73 20 63 6C 65 61 72 6C 79 20 75 6E 73 74 61 62 6C 65 20 74 6F 20 6D 65 2E 20 54 68 65 20 73 75 62 6A 65 63 74 20 73 68 6F 77 73 20 6D 61 6E 79 </br>
20 73 74 72 61 6E 67 65 20 62 65 68 61 76 69 6F 72 2C 20 6C 69 6B 65 20 61 20 72 65 61 6C 6C 79 20 62 72 6F 6B 65 6E 20 6C 61 75 67 68 74 65 72 2E 2E 2E 20 61 6E 64 20 73 6F 20 </br>
6F 6E 2E 20 42 75 74 20 6F 6E 20 6F 75 72 20 6C 61 73 74 20 65 78 70 65 72 69 6D 65 6E 74 2C 20 74 68 61 74 20 67 69 72 6C 20 70 72 6F 64 75 63 65 73 20 73 6F 6D 65 20 77 65 69 </br>
72 64 20 70 69 6E 6B 20 6E 6F 69 73 65 73 2C 20 61 6E 64 20 47 55 45 53 53 20 57 48 41 54 3F 20 53 68 65 20 6A 75 73 74 20 64 69 73 61 70 70 65 61 72 65 64 20 66 72 6F 6D 20 74 </br>
65 73 74 69 6E 67 20 63 68 61 6D 62 65 72 21 0A 49 20 64 6F 6E 27 74 20 6B 6E 6F 77 20 77 68 61 74 20 73 68 6F 75 6C 64 20 49 20 64 6F 20 6E 6F 77 2E 2E 2E 20 47 75 65 73 73 20 </br>
6F 75 72 20 73 65 63 72 65 74 20 65 78 70 65 72 69 6D 65 6E 74 20 69 73 20 67 6F 69 6E 67 20 74 6F 20 62 65 20 68 61 6C 74 65 64 20 66 6F 72 20 73 6F 6D 65 20 64 61 79 73 2E 2E </br>
2E 0A 62 74 77 2C 20 74 68 61 74 20 67 69 72 6C 20 68 61 73 20 61 20 77 6F 6E 64 65 72 66 75 6C 20 76 6F 69 63 65 21 20 48 65 72 20 73 69 6E 67 73 20 6D 6F 76 65 64 20 65 76 65 </br>
72 79 6F 6E 65 20 61 74 20 6F 75 72 20 62 61 73 65 21</br>
</br>

<img src="/assets/binary-image.png">


## 7月15日

49 6E 20 74 6F 64 61 79 27 73 20 77 6F 72 6C 64 2C 20 79 6F 75 20 6D 75 73 74 20 70 72 6F 76 65 20 74 68 61 74 20 79 6F 75 20 61 72 65 20 76 61 6C 75 61 62 6C 65 2C 20 6C 65 74 </br>
20 6F 74 68 65 72 73 20 64 69 73 63 6F 76 65 72 20 79 6F 75 72 20 76 61 6C 75 65 2C 20 61 6E 64 20 6C 65 74 20 6F 74 68 65 72 73 20 22 62 75 79 22 20 79 6F 75 2E 20 4F 6E 63 65 </br>
20 79 6F 75 20 68 61 76 65 20 6E 6F 20 76 61 6C 75 65 2C 20 79 6F 75 20 77 69 6C 6C 20 62 65 20 65 6C 69 6D 69 6E 61 74 65 64 20 62 79 20 74 68 69 73 20 73 6F 63 69 65 74 79 2E </br>
10 57 69 6C 6C 20 74 68 65 20 66 72 65 65 20 73 6F 66 74 77 61 72 65 20 49 20 73 74 75 64 79 20 68 61 76 65 20 63 6F 6D 6D 65 72 63 69 61 6C 20 76 61 6C 75 65 3F 20 4F 62 76 69 </br>
6F 75 73 6C 79 20 6E 6F 74 2E 2E 2E </br>
</br>

## 7月14日

終於知道爲什麼 Q6A 單板機 Linux 支援那麼爛還有人買了，因爲大家買過來之後都跑去改裝 Windows 11 ARM！官方也有釋出驅動程式，除了內建的 Wi-Fi 不可以用，其牠硬體都是正常的。Radxa 他們還發佈了最新採用 Snapdragon 8cx Gen3 (SC8280XP) 晶片的單板電腦，叫做 Radxa Dragon Q8B...我還認爲是 Allwinner `linux-sunxi` 社群裏跑主線 U-Boot 的那個「Q8 Tablet」呢...</br>
</br>
...
Snapdragon 平臺的主線核心 `remoteproc` 驅動程式會在核心開機時重設遠端處理器的運作情況，當核心跑在 EL2 時嘗試啓用遠端處理器就會遇到 `-22 EINVAL` 錯誤。解決方式就是修改核心源碼中的 `qcom_q6v5_pas.c` [這一高通遠端處理器(Q6 DSP)的驅動程式原始碼](https://github.com/sppidy/linux/commit/434c518bbe754f3ba3dea4364e99ab44a224c453)，讓核心的 `qcom_q6v5_pas` 模組能夠「接管」(attech)被 Bootloader 或者其牠開機載入程式預載入的遠端處理器:</br>
...
雖然 Snapdragon 平臺採用 UEFI 韌體，但是 LA 平臺的韌體沒有預載 UEFI 安全啓動簽章，因此並不會被 Black Lotus 漏洞影響...</br>
</br>
...
Qualcomm 的 bootloader 叫做「Core platform boot」，和有名的開源韌體 CoreBoot 有非常相似的名字。巧合的是二者都可以讓使用者客製化自己的韌體，都可以使用 UEFI 或者其牠 payload 開機(高通部分晶片的 XBL 可以改用 U-Boot 開機)。但前者是專有軟體，其原始碼無法獲得。</br>
</br>
...
## 6月6日
 ...
 - Android 不是 GNU/Linux，牠是套用了 Linux 核心，被商業化的「怪物」。真正的自由精神，是 GNU 宣言的低語，是具有法律效力的 GPL 協議；也是在 Linux 核心原始碼中沉睡的「奇跡」。</br>
 </br>
...
...啊哈哈...看來我還沒有準備好求婚的原始碼呢！</br>
 ...
 - Linux 的文檔系統和 UNIX 一樣，都是 `man` 命令。他是一個很小的工具程式，牠可以接受使用者的引數，從而方便妳找到對應的程式幫助文件。如果妳不知道程式的幫助文件怎麼辦？很簡單，鍵入 `man -k <key-words>` 就可以列出包括使用者提供的關鍵字的幫助檔案。</br>
 </br>
...
看到同樣寫 FOSS 議題的 Ivon [把自己的部落格推向國際化的嘗試](https://ivonblog.com/posts/machine-translated-blog-posts/)。我也突然意識到，如果僅僅停留在「漢字文化圈」內，那麼我的部落格是沒有未來的。這一點從我網站的統計數據就可以看到，造訪國家最多的竟然是中國(我的部落格並沒有像 Ivon 那樣做簡繁轉換，真是爲難大陸網友了)，第二才是新加坡。美國也才只有6%。其牠的非「漢字文化圈」的國家訪問量就更少了。我可以理解很多來自美國，日本的使用者造訪部落格時用翻譯程式的艱難。是時候也要開始嘗試把我的部落格推向國際化了。</br>
</br>
...
在我看來無論是主張用中國產 Android 手機的「degoogle 同好會」，還是反賊的觀點都不能接受。專有軟體就是專有軟體，無論哪個國家的都一樣。就是會蒐集使用者的資料和隱私啊，那些「同好會」的人不過是從一捆專有軟體的集合跑到了另一個專有軟體的集合而已。想要做到徹底的 degoogle，就必須在日常使用的軟體中多使用自由軟體，不會依賴於某一方企業給出的方案。像是 Proton 雖然主張「維護使用者隱私」，但我覺得也不能完全相信。</br>
</br>
