...
我的這臺原型機非常好，上面的標籤告訴我它的製造日期在2024年（或者2025年）左右，外觀沒有任何損傷，屏幕也非常的清晰沒有任何瑕疵，而且展示效果非常的豔麗。此外還配備了5G毫米波天線，能夠增強5G網路的穩定性。不知道爲什麼，總覺得屏幕長得和我的 Pixel 7 Pro 好像呀...
...
硬體上，這臺原型機可謂是性能強悍，它搭載了驍龍8 Elite CPU（沒有熔燬的早期版本），雖然是降頻版，主頻只有3628MHz（不如QRD的高），配備了LPDDR5x 16G RAM，512GB UFS 4.0存儲，但是它的性能依然很強悍。從Geekbrench的測試結果來看，多核心分數達到了驚人的7936分，已經超過了三星Galaxy S24 Ultra 的性能。爲了滿足5G網絡的需求，它採用了高通X80 5G數據機，配備了5G毫米波天線，可以提供高達10Gbps的下行速率。其採用的 Fastconnect 7900 Wi-Fi網路卡，支援 Wi-Fi 7 網路。NPU也得到了升級。</br>
