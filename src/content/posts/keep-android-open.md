...
image: 'assets/your-phone-nolonger-belongs-to-you.png'
...
> _Android 一直就是戴着「開放」的僞裝，實際是充滿專有軟體的「間諜程式」。如今的 Android 終於撕開了牠「開放」的僞裝，露出了「間諜軟體」的真面目。_ </br>
...
鑑於部分使用者可能無法理解，我用幾個例子來簡單的描述這一政策實行之後的影響：
 ...
 - 很多人手中都有一些已經停止更新，但在新機上依然能跑的老 App，或者是從舊手機備份出來的 APK 檔。牠們或許承載着妳的美好回憶，或許記錄了妳與家人的點點滴滴，亦或許是妳最喜歡的遊戲...... </br>
 ...
 - 目前我們安裝第三方 APK 時，系統會跳出「不安全」的警告，但通常會有一個「仍要安裝」的選項。</br>
    ...
    妳的處境： 妳與手機之間的關係從「主僕」變成了「監護人與被監護者」。Google 成了那位過度保護的家長，牠幫妳決定了什麼是危險的，甚至剝奪了妳「承擔風險」的自由。</br>
...
> --- [準備, 始作, 플래싱! -- ‘Blue Archive’ 中國 서버 大運動會 主題曲 ‘출발준비(出發準備)!’를 FOSS가 패러디한 버전 (韓國語 버전)]((https://blog.cloudflare88.eu.org/posts/ready-set-flash-korean/)) ，EDK Piepaint 씀

Google把安裝APK的按鈕，跟OEM解鎖放在一起，把牠當作刷機一樣洪水猛獸的存在。總之就是加上諸多限制，警告使用者。</br>
...
- 誰才是主人？ 如果一個裝置不能執行主人命令牠執行的程式碼，那麼這個裝置本質上就不受主人控制。
...
如果我們接受了他們的語言邏輯，我們就已經在心理上交出了手機的主控權。我們必須大聲地告訴這些科技巨頭：我安裝我自己擁有的軟體，這叫行使權利，不叫「側載」。大型科技公司仍然可以在未來的某個時刻奪走我們自由安裝軟體甚至是使用裝置的能力，因此不能專注於某幾家公司提供的服務和生態，必須「去中心化」，必要的服務可以考慮自建。
