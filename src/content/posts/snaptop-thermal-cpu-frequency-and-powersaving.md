...
和我曾經用過的 Apple MacBook Air 相比（不是講好了不宣傳 Apple 產品嗎），這晶片的最高能耗爲80W，一般使用時也有26W。屬於比較耗電的晶片（M1 晶片最高才20W功耗，平日使用也只有18W），當然效能也要比 M1 好上不少。在執行編譯 Linux 核心或者其他程式時，筆電的風扇會全速運轉， CPU 的溫度發熱到91度。平時運作下晶片的溫度則維持在40~50度，無需風扇，僅靠被動散熱就可以。相比其他筆電，Yoga Slim 7x 的 Linux 表現非常「安靜」，是個不錯的日用筆電。</br>
</br>
