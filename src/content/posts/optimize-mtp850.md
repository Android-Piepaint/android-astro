---
title: 我是如何優化我的 MTP850 原型機來實現正常使用的
...
本人很早就對各種各樣的Android 裝置有着濃厚的興致。自從我在國中時獲得了我父親的酷派Cool 1 手機後，一個偶然的機會，我打開了一個叫做“酷安”的應用，在上面發現了人們發佈的各式各樣的刷機教學，並成功刷入Pixel Experience Android 11 後，
我的刷機之路就從此開始了...... </br>
經過3天的時間後，我收到了心念已久的 MTP850 原型機。是的，對於經常折騰原型機的人（還有那些因爲工作原因接觸到的）而言，這算不得什麼。但是，作爲一個普通消費者的我來說，卻是令人興奮的。可能沒有人能夠想象到開箱時的我有多麼開心了。</br>
...
我已經說過，一方面是因爲我有 MTP850 的BSP原始碼，另一方面是因爲它相對容易得到，畢竟妳總可以在鹹魚上找到妳想要的（我絕對沒有業配）！就在下單 MTP850 的前一天，我還發現了一個批發 MTP850 原型機的，價格只需300元（現在845原型機都按一千克賣了嗎）...... </br>
當然，我並沒有下單那一家。

# 準備工作

實際上，因爲我過於糟糕的技術，我的第一臺原型機在到手後不久就“黑磚”了。在嘗試多次修復後無果，我便再一次嘗試與家長談判，經過3個小時的“談判”後，我終於再一次獲得了3臺 MTP850 原型機（爲什麼是3臺？因爲出現了一點“小意外”）。這一次，我終於可以
大幹一場了... </br>
首先，下載一個妳最喜歡的 [GSI 映像](https://github.com/TrebleDroid/treble_experimentations/wiki/Generic-System-Image-%28GSI%29-list)，我建議選用 Google 的 AOSP 14 GSI 和 Lineage 21 映像，因爲系統簡單，BUG 較少（才怪！）然後繼續閱讀： </br>
從這一步開始，根據原型機的情況（目前， 所有 MTP 原型機都分爲兩種平臺—— LA 與 WP），我們需要選擇合適的 GSI 映像刷機： </br>

| LA 平臺 Android 版本     | 可刷 GSI                                                                                                                                                                                                |
|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Android 8       | 妳可以刷寫 “A/B分割” 的映像，最高支援 Android 11。                                                                                                                                                                                    |
| Android 9   |  同上。                                                                                                                                                                           |
| Android 10（妳最常遇到的版本） | 同上，最高支援 Android 14 QPR1。                                                                                                                                                   |
| Android 11       | 同上 |
...
因爲這是原型機， 所以 Bootloader 已經解鎖（我懷疑它根本沒有鎖），自然就可以取得Root權限。但是這不是正常的手機，沒有刷機包可以下載，自然就無法獲取`boot`映像來進行修補。那要怎麼做才能獲得Root權限？
...
之後，手機下載並安裝 [Magisk](https://github.com/topjohnwu/magisk/releases) 在應用程式中，選擇“安裝”，之後選擇“選擇並修補文件”，找到妳的`boot.img` 所在目錄，然後將其拷貝到電腦上 ，手機重啓至fastboot，輸入以下命令：
...
我曾經認爲，高通的原型機系統想必會乾淨且流暢，但是直到我親自體驗後，發現我想多了。</br>
...
當然，我加入了Telegram 上關於MTP845的群組。並且從那裏獲取了自編譯的 Android 12 EDL 刷機包（`小小的數字9` 妳猜我爲什麼會提她？）。刷入後依舊如此。</br>
...
> V8兄弟們V8！真男人就要用ARM V8指令集！妳看這是什麼東西？ 高通MTP845說的呢！（口水噴濺）
> 熔燬的手機我們不要！黑磚危險！


當我成功開機後，我的第一感覺不是無盡的興奮，而是UI卡噸、聲音頓挫，同樣的問題再次出現，彷彿它們註定要與這臺原型機爲伴。
...
:::note
Magisk作者幾年前把內建的模組倉庫砍掉了，使用者得手動下載模組安裝。請不要從不信任的網站上下載模組。來路不明的模組也不要下載！一個惡意的Magisk 模組會使妳的手機系統出現不可修復的錯誤，它們通常是致命的。
:::


 - 首先，下載著名的“YC調度” ，然後在Magisk應用，前往“Modules”，在此介面下，點擊上方的“Install from storage”，在安裝過程中，按下音量加來安装。這也會同時安裝“A-Soul遊戲優化”模組，完成後重新啓動，妳會發現UI明顯順暢了很多。
...
<img src="https://static.wikitide.net/gnugenshinwiki/9/9f/Scene-Why.png" width="300" >
 ...
 - 最後，確保妳已經完成上述操作，然後重新啓動手機試試吧！

# 後記

經過了上述調優之後，這臺MTP850原型機的系統響應速度和順暢度都有了較大的提升，也算是一個可以正常使用的原型機了，也許可以拿去學校摸魚？誰知道呢......
