---
title: （轉載）Everypoints I've Created (Feat. Lahaina Oryon) -- An OpenstreetMap Parody of Everywhere We Go by Edsion Chen (Everypoints I've Created (Feat. Lahaina Oryon)：一個關於 OpenstreetMap 的歌曲改編，基於由陳冠希、MC仁、廚房仔等人所創作的《Everywhere We Go》(Feat. 應采兒))
...
- Everypoints I've Created (Feat. Lahaina Oryon) 歌詞，Lahaina Oryon 版權所有。
- 歌曲 Everywhere We Go (Feat. 應采兒) ，MC仁、廚房仔、陳冠希等版權所有。

如有疑問，請洽版權所有者。
:::

<iframe width="560" height="315" src="https://www.youtube.com/embed/vWl6VdAqtxg?si=TPpX4jdz3mDCgh03" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
仿佛分別之日發生在昨天 </br>
（憑）開放街圖，隨時可以把我找 </br>
執意用 Google（地圖）就當我沒說... </br>

# Part 1

走，去一個未標明的地方， </br>
盡情探索，莫在意別人眼光 </br>
地圖（和）放大鏡[^1]是我們的象徵， </br>
...
（其）地圖數據，（被）各大院校採用研究 </br>
設計（也），簡潔高效、易用 </br>
</br>
測繪方式（也）可與 Google、Apple [^3]匹敵, </br>
（數據）隨時上傳、更新，地圖即刻呈現 </br>
編輯器（也），易於使用輕鬆上手 </br>
（環境）架設完畢，走嘍！ </br>
</br>
</br>
On a phone, a laptop, or any smartwatches, </br>
（在智慧手機、筆記型電腦、亦或是智慧手錶） </br>
Doing everything I can do </br>
（我也可以做任何事） </br>
When I tired, loot at the sky, </br>
（當我疲倦，翻閱天空） </br>
